...
/*   Updated: 2026/03/04 12:06:12 by albben-a         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void print_stack(char *name, t_stack *stack) //comprobaciones
{
	printf("%s: ", name);
	while (stack)
	{
...
{
	//t_stack *b = NULL o se lo enviamos iniciado a null desde fuera
	int	k;
